...
function randoQuote() {
newPara.innerText = pickRandomQuote(inspirationalQuotes)
newPara.style.backgroundColor = getRandomHexColor()
document.getElementById("quotes_container").appendChild(newPara)
}

document.getElementById("random_quote_btn").addEventListener("click", randoQuote)
